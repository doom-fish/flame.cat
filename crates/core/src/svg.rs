        ...
        match cmd {
            ...
            RenderCommand::DrawText {
                ...
                svg.push_str(&format!(
                    ...
                    position.x, position.y, escape_xml(text),
                ));
            }
...
fn resolve_color(token: ThemeToken, dark: bool) -> &'static str {
    if dark {
        match token {
            ...
            ThemeToken::Border | ThemeToken::TableBorder | ThemeToken::AsyncSpanBorder => {
                "#444466"
            }
            ...
            ThemeToken::BarFill | ThemeToken::CounterFill | ThemeToken::AsyncSpanFill => {
                "#6666aa"
            }
